...
class hoiw_eval():
    ...
    def evalution(self, prediction_json):
        ...
        for pred_i in predict_annot:
            ...
            elif 'prediction' in pred_i.keys():
        ...
        if len(pred_hoi) != 0:
            for i, pred_hoi_i in enumerate(pred_hoi):
                ...
                if len(match_pairs) != 0 and pred_hoi_i['subject_id'] in pos_pred_ids and pred_hoi_i['object_id'] in pos_pred_ids:
                    pred_sub_ids = match_pairs[pred_hoi_i['subject_id']] # list of idx of gt box which is matched with pred subject id
                ...
                if 'score' not in pred_hoi_i:
                    self.score[pred_hoi_i['category_id']].append(0.99)
                else:
...
if __name__ == '__main__':
    # gt_json = "../../../HOI-Det/HOI-A-new/train_2021.json"
    gt_json = "/home/nttung/person-in-context/HOI-Det/HOI-A-new/test_2019.json"

    # pred_json = "./result/sim_net_prediction_test_2019_30_epoch_gt_pair.json"

    #### no attention best

    ## gt box
    # pred_json = "./result/sim_net_pair_net_context_30_epoch_prediction_test_2019_30_epoch.json"
    #####

    ## yolo box
    # pred_json = "./result/yolo_detector_sim_net_pair_net_context_30_epoch_prediction_test_2019_30_epoch.json"
    
    ## cascade box
    pred_json = "../result/cascade_tta_box_BPA_17_sim_30_test_2019.json"
    # pred_json = "./result/cascade_detector_sim_net_pair_net_context_30_epoch_prediction_test_2019_30_epoch.json"
    #####

    # no one hot attention best
    # pred_json = "./result/sim_net_pair_net_context_pose_attention_no_one_hot_59_epoch_prediction_test_2019_30_epoch.json"
    # yolo no one hot attention best
    # pred_json = "./result/yolo_sim_net_pair_net_context_pose_attention_no_one_hot_59_epoch_prediction_test_2019_30_epoch.json"

    ### no one hot attention best update
    # yolo
    # pred_json = "../result/yolo_box_BPA_17_sim_30_test_2019.json"


    # try 
    # pred_json = "../result/yolo_box_BPA_17_sim_no_mask_40_test_2019.json"
    
    eval_class = hoiw_eval(gt_json) 
    eval_class.evalution(pred_json)