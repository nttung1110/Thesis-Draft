...
# sys.path.insert(0, "/home/nttung/person-in-context/BPA-Net/external_lib/sota_pose_estimation/deep-high-resolution-net.pytorch/lib")
# sys.path.insert(0, "/home/nttung/person-in-context/BPA-Net/external_lib/sota_pose_estimation/deep-high-resolution-net.pytorch/")
...
def run_single_pose(path_img_in, human_boxes, list_corres_idx_box, IS_VIS):
    # transformation
    ...
    # hard code args
    args = parse_args()
    args.cfg = "/home/nttung/person-in-context/BPA-Net/external_lib/config_infer_pose.yaml"
    ...
    for idx_h_box, pose_preds in zip(list_corres_idx_box, list_pose_preds):
        ...
        out_json[img_name][str(idx_h_box)] = coords_info
